...
<body>
    ...
    <div>
        ...
        <table class="auto-style1" style="height: auto" border="0">
            <tr>
        ...
        <form id="form1" runat="server" class="auto-style13">
            <fieldset>
                <legend>add / remove parking slot</legend>
              <div>
                  ...
                  <table class="auto-style8">
                      <tr>
                          ...
                          <td class="auto-style25">
                              ...
                              <asp:DropDownList ID="DropDownList1" runat="server" Height="45px" Width="250px">
                              </asp:DropDownList>
                      ...
                      <tr>
                          ...
                          <td class="auto-style25">
                              ...
                              <asp:DropDownList ID="DropDownList2" runat="server" Height="45px" Width="250px">
                              </asp:DropDownList>
                      ...
                      <tr>
                          <td class="auto-style24">
                              ...
                              <asp:Button ID="Button1" runat="server" Text="Add Slot" />
                             
                          </td>
                          <td class="auto-style25">
                              
                              <asp:Button ID="Button2" runat="server" Text="Remove Slot" Width="152px" />
